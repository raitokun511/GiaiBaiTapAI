...
public class TestAPI : MonoBehaviour
{
    ...
    public async void TestGeminiChatFromUnity()
    {
        string testMessage = "Cho tôi 1 câu hỏi trắc nghiệm ngẫu nhiên về hóa học phổ thông, chủ đề vô cơ - kim loại. cùng trả về 4 đáp án trong đó có 1 đáp án đúng.\r\nCấu trúc bạn trả về dạng json sau và không thêm bất cứ dữ liệu, câu chào nào:\r\n{\r\n\"question\":\"\",\r\n\"right_ans\":\"\",\r\n\"wrong_1\":\"\",\r\n\"wrong_2\":\"\",\r\n\"wrong_3\":\"\"\r\n}";
        ...
        string followUpMessage = "Bạn có khỏe không?";
        Debug.Log("Gửi câu hỏi tiếp theo: " + followUpMessage);
